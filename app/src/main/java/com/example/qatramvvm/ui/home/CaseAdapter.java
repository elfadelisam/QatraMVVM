...
import com.example.qatramvvm.DetailsCase;
...
public class CaseAdapter extends RecyclerView.Adapter<CaseAdapter.ViewHolder> implements Filterable {
    ...
    public CaseAdapter(List<CasesModel> casesModelList, Context context) {
    ...
    public CaseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CaseAdapter.ViewHolder(v);
    }
    ...
    public void onBindViewHolder(@NonNull CaseAdapter.ViewHolder holder, int position) {
        ...
        holder.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, DetailsCase.class);
